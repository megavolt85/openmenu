...
#define REMAP_ADD_ART(ip, disc)	(serial_remap)	\
{												\
	.ip_serial = ip,							\
	.art_serial = disc,							\
	.remap_choice = REMAP_ART					\
}

#define REMAP_ADD_META(ip, disc) (serial_remap)	\
{												\
	.ip_serial = ip,							\
	.meta_serial = disc,						\
	.remap_choice = REMAP_META					\
}

#define REMAP_ADD_BOTH(ip, disc)(serial_remap)	\
{												\
	.ip_serial = ip,							\
	.meta_serial = disc,						\
	.art_serial = disc,							\
	.remap_choice = REMAP_META | REMAP_ART		\
}
